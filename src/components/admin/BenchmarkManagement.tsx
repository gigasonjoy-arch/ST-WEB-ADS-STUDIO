...
export const BenchmarkManagement: React.FC<BenchmarkManagementProps> = ({ settings, onRefresh }) => {
  const [activeSubTab, setActiveSubTab] = useState<'BENCHMARKS' | 'DISTRICTS' | 'RECOMMENDATIONS'>('BENCHMARKS');
